package by.itcourse.autopark.dao.connectionpool;
...
public final class ConnectionPool {
    ...
    private ConnectionPool() {
        ...
        // по стечению абстоятельств пришлось писать код на чужом ноуте
        // и заново все устанавливать , но resourseBundke не хочет цеплятся,
        // поэтому все захардкодил.
...
//        }
    ...
    public void initPoolData() {
         try{
             ...
             givenAwayConQueue = new ArrayBlockingQueue<Connection>(5);
             connectionQueue = new ArrayBlockingQueue<Connection>(5);

             for (int i = 0; i < 5; i++) {
                Connection connection = DriverManager.getConnection("jdbc:mysql://127.0.0.1/park?useSSL=false","root","1355725hval");
