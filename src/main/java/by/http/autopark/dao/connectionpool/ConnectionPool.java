...
//    private static ConnectionPool testInstance=new ConnectionPool(TEST);
...
//    private ConnectionPool(String test) {
//        logger.debug("конструктор для тестов начал работу");
//
//        DBResourceManager dbResourseManager = DBResourceManager.getInstance();
//
//        this.driverName = dbResourseManager.getTestValue(DBParameter.DB_DRIVER);
//        this.url = dbResourseManager.getTestValue(DBParameter.DB_URL);
//        this.user = dbResourseManager.getTestValue(DBParameter.DB_USER);
//        this.password = dbResourseManager.getTestValue(DBParameter.DB_PASSWORD);
//
//        try {
//            this.poolSize = Integer.parseInt(dbResourseManager
//                    .getValue(DBParameter.DB_POLL_SIZE));
...
//        }
//
//        logger.debug("отработал тестовый конструктор Connection Pool");
//
//    }
...
//    public static ConnectionPool getTestInstance(){
//
//        logger.debug("получаем экземпляр класса ConnectionPool");
//        return testInstance;
//    }
